...
int main(){       
    ...
    lp(n){
        ...
        else if(s.top()=='L' and (ch=='Z' or ch=='F'))continue;
        else if(s.top()=='Z' and ch=='F')continue;
        else if(s.top()=='F' and ch=='Z'){s.pop();s.push(ch);}
        else if(s.top()=='L' and ch=='L')s.pop();
        else if(s.top()=='Z' and ch=='Z')s.pop();
        else if(s.top()=='F' and ch=='F')s.pop();
        else if((s.top()=='Z' or s.top()=='F') and ch=='L'){s.pop();s.push(ch);}
    }
    if(s.size()>0) cout << s.top(); else  cout << "NO animals";
}