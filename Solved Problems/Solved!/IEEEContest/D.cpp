...
int main(){  
    ...
    ll n; cin >> n;
    if(n&1){cout << "AIC & IEEE ALAZHAR are sad"; return 0;}
    sl ss;
    lpk(n){ll i; cin >> i;if(k==0){if(i%2==0){cout << "AIC & IEEE ALAZHAR are sad"; return 0;}}if(k==1){if(i%2!=0){cout << "AIC & IEEE ALAZHAR are sad"; return 0;}}ss.insert(i);}if(ss.size()>2){cout << "AIC & IEEE ALAZHAR are sad"; return 0;}cout << "AIC & IEEE ALAZHAR are happy";
}