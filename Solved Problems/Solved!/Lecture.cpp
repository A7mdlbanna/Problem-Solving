...
int main(){
   fast
    ...
    ll lecture, words;cin >> lecture >> words;
    mss lang;
    w(words){
        string word1, word2;
        cin >> word1 >> word2;
    ...
    w(lecture){
        string lectureWord; cin >> lectureWord;
        if(lang[lectureWord].size() < lectureWord.size())cout << lang[lectureWord] << " ";
        else cout << lectureWord << " ";
    }
}