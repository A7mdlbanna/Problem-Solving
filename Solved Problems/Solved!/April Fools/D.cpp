...
int main(){       
    fast
    // cout << "Hello World";
    string cipher = "defghijklmnopqrstuvwxyzabcDEFGHIJKLMNOPQRSTUVWXYZABC ", alpha = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ";
    string m; getline(cin, m);
    fra(m)cout << alpha[find(all(cipher), i)-cipher.begin()];
}