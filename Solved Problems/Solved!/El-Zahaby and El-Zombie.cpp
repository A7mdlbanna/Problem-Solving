...
int main(){       
    ...
    ll r = count(all(s), 'R');
    ll l = count(all(s), 'L');
    if((x >= 0 and y > 0 and f == x and f == b and r == y and l == r) or (x >= 0 and y < 0 and f == x and f == b and r == -y and l == r) or (x < 0 and y >= 0 and f == -x and f == b and r == y and l == r) or (x < 0 and y <= 0 and f == -x and f == b and r == -y and l == r))cout << "YES";
    else cout << "NO";    
