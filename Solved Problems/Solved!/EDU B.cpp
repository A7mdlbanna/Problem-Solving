...
// #define prec(p)                 fixed << setprecision(p)
#define w(x)                    while(x--)
...
#define en                      end = std::chrono::system_clock::now(); chrono::duration<double> elapsed_seconds = end - start; cout << elapsed_seconds.count() << "s\p";
