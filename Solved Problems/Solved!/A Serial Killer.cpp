...
int main(){
   fast
    ...
    pss victims;
    string intial, victim;
    cin >> intial >> victim;
    victims.first = intial;
    victims.second = victim;
    cout << victims.first << " " << victims.second << endl;
    ...
    w(n){
        ...
        if(killed == victims.first)victims.first = replaced;
        if(killed == victims.second)victims.second = replaced;
